...
#define FE_MEM(base, sc, idx, off)                                             \
  (INT64_MIN | ((int64_t)((base) & 0xfff) << 32) |                             \
   ((int64_t)((idx) & 0xfff) << 44) | ((int64_t)((sc) & 0xf) << 56) |          \
   ((off) & 0xffffffff))
...
/** Do not use. **/
#define fe_enc64_1(buf, mnem, op0, op1, op2, op3, ...)                         \
  fe_enc64_impl(buf, mnem, op0, op1, op2, op3)
...
/** Do not use. **/
int fe_enc64_impl(uint8_t** buf, uint64_t mnem, FeOp op0, FeOp op1, FeOp op2,
                  FeOp op3);
